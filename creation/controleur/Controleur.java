...
public class Controleur
{
	...
	{ 
		return Casting.valueOf ( indice ).getLibelle(); //Retourne le Libéllé du casting dont l'indice est entré en paramètre
	}
	
	public String            getRole      (int indice)
	{
		return Role.valueOf    ( indice ).getLibelle(); //Retourne le Libéllé du role dont l'indice est entré en paramètre
	}

	//page 1: panel de saisie
