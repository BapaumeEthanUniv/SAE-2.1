...
public class PanelZone extends JPanel implements ActionListener
{
    ...
    public PanelZone(Controleur ctrl, FrameCreation f, int indice)
    {
		...
		this.tabPnlCases 		= new JPanel[this.tailleLigne][this.tailleColonne];
		
		this.setLayout(new BorderLayout(0, 10));

		// Essai d'utiliser la police téléchargée dans le dossier polices/
		try
		{
		...
		JPanel pnlBtnSuite      = new JPanel(new GridLayout(2,2, 5, 5));
