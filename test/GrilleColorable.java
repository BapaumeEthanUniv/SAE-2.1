...
public class GrilleColorable extends JFrame {
    ...
    static {
        ...
        PALETTE.put("Rouge",        new Color(220, 50,  50));
    ...
    private Color couleurActuelle = new Color(220, 50, 50); // rouge par défaut
    ...
    public GrilleColorable(int n) {
        ...
        setTitle("Grille Colorable " + n + "×" + n);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new BorderLayout(0, 0));
        getContentPane().setBackground(new Color(28, 28, 35));

        add(creerBandeauTitre(), BorderLayout.NORTH);
        add(creerPanneauGrille(), BorderLayout.CENTER);
        add(creerBarreOutils(), BorderLayout.SOUTH);
    ...
    private JPanel creerBandeauTitre() {
        ...
        btnEffacer.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        btnEffacer.addActionListener(e -> toutEffacer());
        btnEffacer.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) { btnEffacer.setBackground(new Color(80, 80, 100)); }
            public void mouseExited(MouseEvent e)  { btnEffacer.setBackground(new Color(60, 60, 75)); }
        });
    ...
    public static void main(String[] args) {
        int taille = 10; // valeur par défaut
